<x-main-layout>
    <div class="m-2 p-2 flex justify-between">
        ...
        <div class="flex space-x-2 font-bold text-yellow-300">
            From:
    ...
    <div class="mb-16 flex flex-wrap">
                ...
                @auth
                    <div class="flex space-x-2 p-4" x-data="{
                        ...
                        <button type="button" @click="onHandleLike"
                            class="text-white  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" :class="eventLike ? 'bg-red-700 hover:bg-red-800' : 'bg-slate-400 hover:bg-slate-500'">
        ...
        <div class="w-full shrink-0 grow-0 lg:w-6/12 lg:pl-6  rounded-md p-2 bg-slate-300">
            <p class="mb-6 text-sm text-yellow-600 dark:text-neutral-800 font-bold">
            ...
            <p class="mb-6 mt-4 text-neutral-500 dark:text-neutral-500 font-bold">
                {{ $event->description }}
            </p>
